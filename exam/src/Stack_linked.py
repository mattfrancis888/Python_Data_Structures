...
class Stack:
    ...
    def push(self, value):
        ...
        #Set top as stack node object with value as parameter and setting the _next as top
    ...
    def pop(self):
        ...
        value = self._top._value #value = top value
        self._top = self._top._next #Set top as the next value
    ...
    def combine(self, source1, source2):
        ...
        while source1._top is None and source2._top is not None:
            self._move_top(source2)
        while source2._top is None and source1._top is not None:
            self._move_top(source1)
