...
class List:
    ...
    def insert(self, i, value):
        ...
        #If you have [0,1,2]; -1 would be 3 - 1 = 2 so list[2]
        if i < 0:
            i = self._count + i
    ...
    def _linear_search(self, key):
        ...
        #Current would be None if key is not found
    ...
    def remove(self, key):
        ...
        #1 - Key not in list
        #2 - Remove first node
        #3 - Only 1 node in the list; and you remove it
        #4 - Remove any other node
        #5 - Node is removed and it has no nodes after it
        # search list for key.
    ...
    def remove_many(self, key):
        ...
        """
        #Conditions:
        #1 - Remove when only 1 item in list
        #2 - Remove node in a list
        #3 - Remove last node in list so update rear
        previous = None
        current = self._front
    ...
    def reverse(self):
        ...
        -------------------------------------------------------
        """
        #Note: Idk bow to do it
        new_front = None
        
        #Say [1,2,3,4] to [4,3,2,1]
        if self._front is not None:
            #Rear is now front
            self._rear = self._front 
            #Front is equal to next front; will use in loop
            self._front = self._front._next # 1 = 2
            #Change next to No ne because self._front wasn't None
            self._rear._next = None
            #New_front is self._front; why?
            new_front = self._rear # 1
            
        #reverse the middle nodes now
        while self._front is not None: # 2
            temp = self._front._next # 3
            #Move to next node
            self._front._next = new_front # 4 
            #New_front is the middle node looping
            new_front = self._front # 4 = 2
            #Middle node looping is the next node
            self._front = temp # 2 = 3
    ...
    def clean(self):
        ...
        #Conditions
        #1 - Removing a node
        #2 - Removing last node ; need to update Rear
        cleaned_list = []
        current = self._front
        previous = None
        while current is not None:
    ...
    def intersection(self, source1, source2):
        ...
        #Say: A = [1,2,3,4] B = [2,3] 
        #It will be C = [2,3]
        #Check if node is in source and source 2
        #If yes, check if in self/target; if no, append to self/target
    ...
    def union(self, source1, source2):
        ...
        """
        #Say: A = [1,2,3] B = [3,4]
        #It will be C = [1,2,3,4]
        
        #In source1 and source2 iterate each value
        #Check if value is already in self
        #If
        source1_node = source1._front
    ...
    def split(self):
        ...
        for _ in range(middle):
            #for loop would not run if middle = 0 (empty list)
            previous = current
            current = current._next
        ...
        #previous can only be None if list is empty
    ...
    def union_r(self, source1, source2):
        ...
        -------------------------------------------------------
        """
        #Iterate both lists, add node to self if haven't
        #been added
    ...
    def _reverse_r_aux(self, new_front):
        ...
        Use: self.reverse_r_aux(new_front)
        -------------------------------------------------------
        Parameters:
