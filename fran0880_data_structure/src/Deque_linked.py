...
class Deque:
    ...
    def insert_front(self, value):
        ...
        """
        if self._count == 0:
            self._front = _Deque_Node(deepcopy(value), None , None)
            self._rear = self._front
        else:
            self._front =_Deque_Node(deepcopy(value), self._front._prev, self._front) 
    ...
    def insert_rear(self, value):
        ...
        if self._count != 0:
            #last element
            new_node = _Deque_Node(deepcopy(value), self._rear, None)
            self._rear._next = new_node
            self._rear = new_node
        
        else:
            new_node = _Deque_Node(deepcopy(value), None, None)
