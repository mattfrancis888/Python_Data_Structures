...
class List:
    ...
    def combine(self, source1, source2):
        ...
        while len(list_s1) != 0 or len(list_s2) != 0:
            ...
            if len(list_s1) == 0:
                self._values.append(list_s2[0])
                list_s2.remove(list_s2[0])
            
            elif len(list_s2) == 0:
                self._values.append(list_s1[0])
                list_s1.remove(list_s1[0])
...
#             self._values.insert(i, deepcopy(value))
    ...
    def split(self):
        ...
        target1 = List()
        target2 = List()
        mid_index = int(len(self._values) / 2)
        is_even = len(self._values) % 2 == 0
